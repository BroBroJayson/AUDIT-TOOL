...
class UM_RCV_DR_Export implements FromArray, ShouldAutoSize, WithEvents
{
    protected $file1Rows = [];
    protected $file2Rows = [];
    ...
    public function array(): array
    {
        ...
        // Title for File 1
        $output[] = ['RECEIVE ITEMS']; // Title row
        // File 1 Header
        $output[] = [
            'PREPARED BY', 'REC#', 'PO#', 'SI#', 'DATE',
            'ITEM CODE', 'ITEM NAME', 'CATEGORY', 'QTY',
            'STATUS', 'PURCHASE PRICE', 'LESS', 'COST', 'SRP', 'AMOUNT'
        ];
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function (AfterSheet $event) {
            ...
            $sheet->setCellValue('A1', 'RECEIVE ITEMS');
            ...
            // === File 1 Header ===
            $sheet->getStyle('A2:O2')->getFont()->setBold(true)->getColor()->setRGB('FFFFFF');
            $sheet->getStyle('A2:O2')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setRGB('0070C0');
            ...
            $sheet->setCellValue("A{$file2TitleRow}", 'DELIVERY ITEMS');
